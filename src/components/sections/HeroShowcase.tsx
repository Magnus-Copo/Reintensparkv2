...
export function HeroShowcase() {
  ...
  return (
    <div className="relative flex w-full max-w-3xl flex-col gap-6 overflow-hidden rounded-[32px] border border-white/10 bg-white/5 p-8 text-white/80 fade-up fade-delay-2 mx-auto lg:mx-0">
      <div className="absolute inset-0 -z-10 rounded-[32px] bg-gradient-to-b from-transparent via-primary/5 to-transparent blur-2xl" />
      <div className="relative aspect-[16/10] w-full rounded-3xl border border-white/10 bg-white/5 shadow-[0_8px_40px_rgba(0,0,0,0.3)]">
        {slides.map((slide, slideIndex) => (
          <iframe
            ...
            className={cn(
              "absolute inset-0 h-full w-full rounded-3xl transition-opacity duration-700",
      ...
      <div key={active.title} className="space-y-3">
