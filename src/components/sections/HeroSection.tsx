...
export const HeroSection = memo(function HeroSection() {
  return (
    <section className="full-bleed relative isolate overflow-hidden border-y border-white/10 bg-gradient-to-br from-black via-slate-900/60 to-slate-900 py-8 sm:py-12 md:py-16 shadow-[0_20px_120px_rgba(0,0,0,0.55)] -mt-6 sm:-mt-8 lg:-mt-10">
      ...
      <div className="relative z-10 mx-auto flex max-w-[1800px] flex-col gap-8 px-4 sm:gap-12 sm:px-6 md:px-8 lg:flex-row lg:items-start lg:justify-between lg:gap-20 lg:px-10">
        <motion.div 
          className="flex-1 space-y-4 sm:space-y-6 text-center lg:max-w-3xl lg:text-left"
          initial="hidden"
          animate="visible"
        ...
        >
          ...
          <motion.h1 
            className="display-font mt-4 sm:mt-6 text-2xl sm:text-3xl md:text-4xl font-semibold leading-tight text-white"
            variants={fadeInUp}
          >
            Transforming Knowledge into <span className="sm:whitespace-nowrap">Real-World Innovation.</span>
          </motion.h1>
          <motion.p 
            className="mt-4 sm:mt-6 text-sm sm:text-base text-white/70 mx-auto lg:mx-0 max-w-3xl leading-relaxed text-justify"
            variants={fadeInUp}
          >
        ...
        <motion.div
          className="hidden md:block flex-shrink-0 lg:max-w-2xl"
