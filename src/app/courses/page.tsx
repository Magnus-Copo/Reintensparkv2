      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {courses.map((course, index) => (
          <motion.div
            ...
            whileHover={{ y: -8 }}
            className="group relative flex flex-col overflow-hidden rounded-[24px] border border-white/10 bg-gradient-to-br from-card/80 via-card/60 to-black/80 transition-all duration-300 hover:border-primary/30 hover:shadow-[0_0_30px_rgba(57,255,20,0.2)] max-w-[380px] mx-auto w-full"
          >
            {/* Course Image */}
            ...
            <div className="p-5 flex flex-col flex-1">
              ...
              <motion.button
                ...
                className="w-full rounded-full border border-primary/30 bg-primary/10 py-2.5 text-base font-semibold text-primary transition-all hover:bg-primary hover:text-black focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-black mt-auto"
